...
namespace ExtensionsAndStuff.ValueTupleExtensions
{
    public static class NullCheckExtensions
    {
        ...
        public static void NullCheck<T1, T2>(this (T1, T2) value)
        ...
        public static void NullCheck<T1, T2, T3>(this (T1, T2, T3) value)
        ...
        public static void NullCheck<T1, T2, T3, T4>(this (T1, T2, T3, T4) value)
        ...
        public static void NullCheck<T1, T2, T3, T4, T5>(this (T1, T2, T3, T4, T5) value)
        ...
        public static void NullCheck<T1, T2, T3, T4, T5, T6>(this (T1, T2, T3, T4, T5, T6) value)
        ...
        public static void NullCheck<T1, T2, T3, T4, T5, T6, T7>(this (T1, T2, T3, T4, T5, T6, T7) value)
