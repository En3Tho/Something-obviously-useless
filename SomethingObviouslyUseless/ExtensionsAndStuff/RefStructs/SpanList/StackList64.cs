...
{
    public ref struct StackList64<T> where T : class
    {
        private readonly ReferenceValueHolder64<T> _values;
        private readonly Span<T> _span; // Unsafe.Add?
        
        public int Count { [MethodImpl(MethodImplOptions.AggressiveInlining)] get; private set; }
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public StackList64(IEnumerable<T> values)
        {
            _values = default;
            Count = 0;
