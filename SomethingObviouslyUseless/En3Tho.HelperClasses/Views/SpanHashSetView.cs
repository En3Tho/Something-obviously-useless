...
// {
//     public ref struct SpanHashSetView<T>
//     {
...
//
//         public SpanHashSetView(Span<int> buckets, Span<Entry> entries, bool clear = false)
//         {
//             _buckets = buckets;
//             _entries = entries;
//             Count = 0;
...
// #else
//             return ref buckets[(int)((uint)hashCode % (uint)buckets.Length)];
// #endif
//         }
//
...
//             if (!typeof(T).IsValueType && comparer is NonRandomizedStringEqualityComparer)
//             {
...
//             }
//         }
//         // Copy HashSetLogic w/o resizing
//     }
// }