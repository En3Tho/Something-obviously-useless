...
namespace LearnIntermediateLanguage
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var a = new A(Guid.Empty, 15, "15", new C());
            var a2 = new A(Guid.Empty, 15, "15", new C());
            ...
            //
            // var ileqignmembersA = ILEqualityComparer<A>.FromIgnoreMemberExpressions(x => x.Int2, x => x.Int);
