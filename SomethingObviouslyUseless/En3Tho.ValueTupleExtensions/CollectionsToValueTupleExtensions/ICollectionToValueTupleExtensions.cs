...
namespace En3Tho.ValueTupleExtensions.CollectionsToValueTupleExtensions
{
    public static partial class ICollectionToValueTupleExtensions
    {
        ...
        public static TResult[] Map<TSource, TResult>(this ICollection<TSource> source, Func<TSource, int, TResult> mapper)
        {
            var result = new TResult[source.Count];
            int j = 0;
            foreach (var obj in source)
        ...
        public static (TResult1[], TResult2[]) Map<TSource, TResult1, TResult2>(this ICollection<TSource> source, Func<TSource, int, TResult1> mapper1, Func<TSource, int, TResult2> mapper2)
        {
        ...
        public static (TResult1[], TResult2[], TResult3[]) Map<TSource, TResult1, TResult2, TResult3>(this ICollection<TSource> source, Func<TSource, int, TResult1> mapper1,
        ...
        public static (TResult1[], TResult2[], TResult3[], TResult4[]) Map<TSource, TResult1, TResult2, TResult3, TResult4>(this ICollection<TSource> source, Func<TSource, int, TResult1> mapper1,
